...
const BlogArticleDetails: FC = () => {
  ...
  const [article, setArticle] = useState<ArticleModel>({} as ArticleModel);
  ...
  const getArticleById = async () => {
    let article = await blogService.getArticleById(parseInt(id!));
    if (article) {
      setArticle(article);
    }
  };
      ...
      <div className="blog-content-container">
        <div className="blog-content-inner">
          ...
          <div className="paragraph-container">
            ...
            <p className="article-paragraph">
              With a very low costing starting bid of just $1, you are
              guaranteed to have a spot in MTA’s successful directory list. When
              you would like to increase your bid to one of the top positions,
              you have to know that this would be a wise decision to make as it
              will not only get your link to be at a higher point in the
              directory but it will also give you a chance to have your site
              advertised with the rest of the top ten on the home page of the
              website. This means that when visitors come to{" "}
              <span className="article-link">MTAweb.com</span>, your site will
              be one of the first things they see. In other words, you stand a
          ...
          <ul>
            <li>
              Implements{" "}
              <span className="article-link">This is an external link</span>
            </li>
            <li>
              Implements{" "}
              <span className="article-link">This is an inside link</span>
            </li>
          ...
          <div className="article-blockquote quote-p">
            <span>Life is short, Smile while you still have teeth! </span>
          </div>
          <div className="block-code">
            ...
            <div className="tags">
              ...
              <div className="tag">Health and Wellness</div>
